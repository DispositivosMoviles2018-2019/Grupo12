package ec.edu.uce.appbackground;
...
public class DownloadActivity extends Activity {
    ...
    public void onResume() {
        ...
        if(!prefs.contains(DL_ID)) {
        	...
        	Uri resource = Uri.parse("https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/styles/main_element/public/media/image/2018/07/one-piece.jpg?itok=gTjMCD3Q");
